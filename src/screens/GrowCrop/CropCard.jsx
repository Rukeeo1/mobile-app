  ...
  useEffect(() => {
    if (cropToGrowDetails) {
      ...
      if (
        ...
        setToUseCropType(
          currentJob?.jobs[0]?.crop_type || cropToGrowDetails?.crop_variety
        );
    ...
    if (cropToGrowDetails?.fromJobs) {
      ...
      if (jobType === "SOW") {
        ...
        jobInfo = {
          ...
          crop_type: cropToGrowDetails?.crop_variety,
          title: "SOW",
          status: "STARTED",
          job_type: "SOW",
          sow_date: ourDate,
  ...
  return (
    <SafeArea containerStyle={{ flex: 1 }}>
      ...
      >
        ...
        <View
          style={{ paddingHorizontal: "1%", marginLeft: 10, marginRight: 10 }}
        >
          {activeScreen === 0 && (
            <>
            ...
            <>
              <HarevestDatePicker
                ...
                currentJobDate={
                  ...
                  typeof currentJob?.jobs !== "undefined" &&
                  typeof currentJob?.jobs[0] !== "undefined"
                    ? currentJob?.jobs[0]?.job_date
                    : cropToGrowDetails.jobDate
                }
