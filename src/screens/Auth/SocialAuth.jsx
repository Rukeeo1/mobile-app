...
export const Login = ({ navigation }) => {
  ...
  const GoogleSignin = async () => {
    try {
      ...
      if (
        message === GoogleSignIn.ERRORS.SIGN_IN_NETWORK_ERROR ||
        message === "GoogleSignIn.null: NETWORK_ERROR"
      ) {
        errorMessage =
          "Network error occured. Please check your internt connection and try again";
      }
      Alert.alert("", errorMessage, [{ text: "Dismiss" }]);
    }
  };
