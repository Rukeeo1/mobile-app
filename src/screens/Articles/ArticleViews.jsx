...
const ArticleViews = ({ navigation }) => {
  const dummyItems = [
    ...
    {
      title: "Jargon Buster",
      body: "Get up to speed, with some of the most common gardening jargon explained",
    },
    {
  ...
  const renderArticleCard = ({ item, index }) => (
    <View>
      <Image
        source={{
          uri: "https://images.pexels.com/photos/4622253/pexels-photo-4622253.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500",
        }}
        style={{
          width: "100%",
